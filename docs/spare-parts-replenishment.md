...
- `/inventory/spare-parts-replenishment` — مسار التموين الكامل
- `/inventory/warehouses/:warehouseId` — مساحة شاملة لكل مخزن (أرصدة، حركات، إجراءات حسب الدور)
- منتج تام: من مساحة المخزن → اعتماد التحويلات / اعتمادات الإنتاج

## قواعد مرتبطة

- اختيار قطع الغيار في طلب الصيانة **غير مقيد بـ BOM المنتج**
- تسعير تكلفة الشراء في شاشة قطع غيار الفرع **للعرض فقط**؛ البيع/الخصم قابل للتعديل
