    ...
    <OpsDashPanel title="قواعد تقارير الإنتاج">
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          {toggle('إلزام أمر شغل في الإدخال السريع', 'عند التشغيل يجب اختيار أمر شغل موجّه للمشرف قبل حفظ التقرير من الإدخال السريع، ويرتبط التقرير بهذا الأمر.', behavior.requireWorkOrderOnQuickAction, () => patchBehavior({ requireWorkOrderOnQuickAction: !behavior.requireWorkOrderOnQuickAction }))}
