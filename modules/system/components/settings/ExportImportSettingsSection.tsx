      ...
      <Card title="القوالب (Templates)">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {[
            ...
            { label: 'قالب بيانات المنتجات', desc: 'بيانات المنتج فقط + عمود منتج تصنيعي — بدون BOM', icon: 'inventory_2', page: 'المنتجات → بيانات أساسية → تحميل قالب' },
            { label: 'قالب المكونات', desc: 'كود منتج + كود مادة؛ كمية فاضي = قطع صيانة', icon: 'account_tree', page: 'المنتجات → مكونات → تحميل قالب' },
            { label: 'قالب المواد التصنيعية', desc: 'ماستر المواد أولاً — ثم المنتجات ثم المكونات', icon: 'precision_manufacturing', page: 'المواد التصنيعية → تحميل قالب' },
