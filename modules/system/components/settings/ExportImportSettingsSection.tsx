      ...
      <Card title="التصدير (Excel Export)">
        <div className="space-y-3">
          {[
            ...
            { section: 'مكونات المنتجات (BOM)', page: 'صفحة المنتجات', path: '/products', icon: 'account_tree', color: 'text-cyan-500', features: ['كل صف: اسم المنتج + المكوّن وتفاصيله (نوع/فئة/وحدة/كمية/هالك/تكلفة)', 'فلتر فئة قبل التصدير (فئة معيّنة أو كل الفئات)', 'أرصدة اللوكيشنات + متوافق مع رفع/تحديث المكونات'] },
