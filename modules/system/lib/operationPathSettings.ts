...
export const PRODUCTION_REPORT_CREATE_PATHS = {
  ...
  supervisorDashboard: 'supervisor_dashboard',
...
export const OPERATION_PATH_REGISTRY: ReadonlyArray<OperationPathRegistryEntry> = [
  ...
  },
  {
    ...
    paths: [
      ...
      { key: PRODUCTION_REPORT_CREATE_PATHS.supervisorDashboard, label: 'لوحة المشرف', description: 'تقرير سريع من أمر شغل على لوحة المشرف (كمية/ساعات/عمالة).' },
