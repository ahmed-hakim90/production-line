            ...
            {reports.length > 0 && (
              <div className="px-6 py-4 bg-[#f8f9fa]/50 border-t border-[var(--color-border)]">
                <span className="text-sm text-[var(--color-text-muted)] font-bold">
                  ...
                  {reports.length > 30 && <span className="text-[var(--color-text-muted)] mr-2">— عرض أحدث 30</span>}
                </span>
              </div>
            )}
          </Card>
                  ...
                  <Card key={line.lineId}>
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-[var(--border-radius-lg)] bg-teal-500/10 flex items-center justify-center">
