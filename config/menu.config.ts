  ...
  },
  {
    ...
    children: [
      ...
      { key: 'accounting-chart', label: 'شجرة الحسابات', icon: 'account_tree', path: '/accounting/chart', permission: 'accounting.view' },
      {
        ...
        anyOfPermissions: ['costs.view', 'accounting.view'],
        activePatterns: ['/accounting/cost-centers/'],
      },
      { key: 'monthly-costs', label: 'تكلفة الإنتاج الشهرية', icon: 'price_check', path: '/accounting/monthly-costs', permission: 'costs.view' },
      { key: 'cost-assets', label: 'الأصول', icon: 'precision_manufacturing', path: '/accounting/assets', permission: 'assets.view', activePatterns: ['/accounting/assets/'] },
      { key: 'cost-assets-depreciation', label: 'تقرير الإهلاك', icon: 'receipt_long', path: '/accounting/depreciation-report', permission: 'assets.depreciation.view' },
      { key: 'cost-health', label: 'صحة بيانات التكاليف', icon: 'verified_user', path: '/accounting/cost-health', permission: 'costs.view' },
      { key: 'cost-settings', label: 'إعدادات التكلفة', icon: 'payments', path: '/accounting/cost-settings', permission: 'costs.manage' },
