  ...
  },
  {
    ...
    children: [
      ...
      { key: 'supervisor-line-assignments', label: 'توزيع المشرفين', icon: 'supervisor_account', path: '/supervisor-line-assignments', permission: 'supervisorAssignments.manage' },
      {
        ...
        activePatterns: ['/production-workers/', '/production/workers/'],
      },
      {
        key: 'production-worker-ratings',
        label: 'مراجعة تقييمات العمال',
        icon: 'rate_review',
        path: '/production/worker-ratings',
        permission: 'production.workerRatings.view',
        anyOfPermissions: ['production.workerRatings.view', 'production.workerRatings.manage', 'hr.evaluation.approve'],
      },
      {
        key: 'production-worker-reports',
        label: 'تقارير عمال الإنتاج',
        icon: 'assessment',
        path: '/production/worker-reports',
        permission: 'production.workerReports.view',
        anyOfPermissions: ['production.workerReports.view', 'productionWorkers.view', 'production.workers.view'],
      },
