...
export const PRINT_DOCUMENT_REGISTRY: PrintDocumentRegistryEntry[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      COMMON_KPIS,
      { key: 'itemCode', labelAr: 'كود الصنف', defaultVisible: true, descriptionAr: 'كود الصنف تحت الاسم', icon: 'tag' },
      { key: 'location', labelAr: 'الرف', defaultVisible: true, descriptionAr: 'عمود موقع الرف', icon: 'shelves' },
      { key: 'quantityPieces', labelAr: 'عمود القطع', defaultVisible: true, descriptionAr: 'عمود عدد القطع', icon: 'numbers' },
      { key: 'lines', labelAr: 'جدول البنود', defaultVisible: true, descriptionAr: 'جدول أصناف الإذن', icon: 'table_rows' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'products', labelAr: 'تفصيل المنتجات', defaultVisible: true, descriptionAr: 'خدمات وقطع كل منتج مع التكلفة', icon: 'inventory_2' },
      COMMON_SIGNATURES,
    ],
  },
  {
  ...
  {
    id: 'sparePartsReplenishment',
    labelAr: 'طلب تموين قطع غيار',
    fields: [
      COMMON_META,
      COMMON_KPIS,
      { key: 'lines', labelAr: 'بنود الطلب', defaultVisible: true, descriptionAr: 'جدول الأصناف والكميات', icon: 'list_alt' },
      { key: 'costs', labelAr: 'التكلفة', defaultVisible: true, descriptionAr: 'تكلفة البند والإجمالي', icon: 'payments' },
      { key: 'notes', labelAr: 'الملاحظات', defaultVisible: true, descriptionAr: 'ملاحظة الطلب إن وُجدت', icon: 'notes' },
      COMMON_SIGNATURES,
    ],
  },
  {
    ...
    fields: [
      ...
      { key: 'qrCode', labelAr: 'رمز QR', defaultVisible: false, descriptionAr: 'اختياري — الباركود الخطي بياخد عرض الملصق لما QR مقفول', icon: 'qr_code' },
