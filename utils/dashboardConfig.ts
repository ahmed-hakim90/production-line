...
export const AVAILABLE_QUICK_ACTIONS: QuickActionDefinition[] = [
  ...
  { key: 'employees', label: 'الموظفين', icon: 'groups', color: 'emerald', actionType: 'navigate', target: '/hr/employees', permission: 'employees.view' },
...
export const DEFAULT_PLAN_SETTINGS: PlanSettings = {
  ...
  enablePackagingStockTransfer: false,
  ...
  repairSettings: {
    ...
    workflow: {
      statuses: [
        ...
        { id: 'diagnosing', label: 'جاري الفحص', color: '#f59e0b', order: 2, isTerminal: false, isEnabled: true },
        { id: 'diagnosed', label: 'تم الفحص', color: '#ca8a04', order: 3, isTerminal: false, isEnabled: true },
        { id: 'estimate_ready', label: 'التقدير جاهز لمراجعة الاستقبال', color: '#0284c7', order: 4, isTerminal: false, isEnabled: true },
        { id: 'waiting_approval', label: 'بانتظار موافقة العميل', color: '#a855f7', order: 5, isTerminal: false, isEnabled: true },
        { id: 'waiting_parts', label: 'بانتظار قطع الغيار', color: '#ea580c', order: 6, isTerminal: false, isEnabled: true },
        { id: 'repairing', label: 'إصلاح', color: '#0ea5e9', order: 7, isTerminal: false, isEnabled: true },
        { id: 'testing', label: 'اختبار', color: '#6366f1', order: 8, isTerminal: false, isEnabled: true },
        { id: 'ready', label: 'جاهز للتسليم', color: '#22c55e', order: 9, isTerminal: false, isEnabled: true },
        { id: 'delivered', label: 'تم التسليم', color: '#16a34a', order: 10, isTerminal: true, isEnabled: true },
        { id: 'cancelled', label: 'ملغى', color: '#78716c', order: 11, isTerminal: true, isEnabled: true },
        { id: 'unrepairable', label: 'غير قابل للإصلاح', color: '#ef4444', order: 12, isTerminal: true, isEnabled: true },
      ],
