...
export const EXPORT_IMPORT_PAGE_REGISTRY: ExportImportPageRegistryItem[] = [
  ...
  { key: 'costCenters', label: 'صفحة مراكز التكلفة', path: '/accounting/cost-centers' },
  { key: 'monthlyProductionCosts', label: 'صفحة تكلفة الإنتاج الشهرية', path: '/accounting/monthly-costs' },
