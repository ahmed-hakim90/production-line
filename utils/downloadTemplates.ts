...
export function downloadHRTemplate() {
  ...
  const empAoa: (string | number | string)[][] = [
    ['اسم الموظف', 'الرمز', 'القسم', 'المنصب', 'المستوى', 'نوع التوظيف', 'الراتب الأساسي', 'أجر الساعة', 'الوردية', 'المركبة', 'البريد الإلكتروني', 'الحالة', 'صلاحية النظام'],
    ['أحمد محمد', 'EMP-001', 'قسم الإنتاج', 'مشغل آلة', 1, 'دوام كامل', 3000, 18.75, 'وردية صباحية', 'سيارة نقل 1', 'ahmed@company.com', 'نشط', 'لا'],
