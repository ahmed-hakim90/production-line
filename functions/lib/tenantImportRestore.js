...
async function adminClearCollection(db, name) {
...
async function adminClearCollectionGroup(db, groupName) {
...
async function adminWriteDocuments(db, collectionName, documents, mode) {
...
async function adminWriteCollectionGroupDocuments(db, collectionGroupName, documents, mode) {
    if (mode === 'replace' || mode === 'full_reset') {
...
export async function runAdminImportBackup(db, file, mode) {
