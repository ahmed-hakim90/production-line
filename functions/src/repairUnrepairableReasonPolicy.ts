export type UnrepairableReasonOption = {
  id: string;
  label: string;
  enabled?: boolean;
};

export const DEFAULT_UNREPAIRABLE_REASONS: UnrepairableReasonOption[] = [
...
export function normalizeUnrepairableReasons(raw: unknown): UnrepairableReasonOption[] {
...
export function resolveUnrepairableReason(
  rawCatalog: unknown,
  reasonCode: unknown,
): UnrepairableReasonOption | null {
