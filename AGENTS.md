...
- **`functions/` pins Node 20** but the VM runs Node 22. Typecheck/build still work; the `EBADENGINE` warning during `npm install --prefix functions` is harmless.
