...
const StorageIcon: React.FC<IconSvgProps> = ({ className, color = "var(--chart-1)" }) => (
  <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
...
const SalariesIcon: React.FC<IconSvgProps> = ({ className, color = "var(--color-primary-hex)" }) => (
  <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
...
const ToolsIcon: React.FC<IconSvgProps> = ({ className, color = "var(--color-warning-hex)" }) => (
  <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
...
const RentIcon: React.FC<IconSvgProps> = ({ className, color = "var(--color-text)" }) => (
  <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
...
const DepreciationIcon: React.FC<IconSvgProps> = ({ className, color = "var(--color-danger-hex)" }) => (
  <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
    <path d="M12 5v14M7.5 8.5h7.7a2.5 2.5 0 0 1 0 5H9.8a2.5 2.5 0 0 0 0 5h6.7" stroke={color} strokeWidth="1.7" />
  </svg>
);

const ElectricityIcon: React.FC<IconSvgProps> = ({ className, color = "var(--color-warning-hex)" }) => (
  <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
...
const CustomIcon: React.FC<IconSvgProps> = ({ className, color = "var(--color-text-muted)" }) => (
  <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
...
function CostCard({ item }: { item: IndirectCostItem }) {
  ...
  const customColor = item.iconType === "custom" ? item.iconColor ?? "var(--color-text-muted)" : undefined;
